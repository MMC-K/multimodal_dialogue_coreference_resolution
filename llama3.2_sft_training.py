...
# 모델과 토크나이저 초기화
model_name = f"meta-llama/Llama-3.2-{NUM_PARAM}"  # 또는 다른 Llama-2 모델
...
print(f"[***] TOTAL_DATA_COUNT: {TOTAL_DATA_COUNT}, TRAIN_DATA_COUNT: {TRAIN_DATA_COUNT}, TEST_DATA_COUNT: {TEST_DATA_COUNT}")
...
trainer = SFTTrainer(
    ...
    callbacks=[aim_callback, GenerationCallback(processor, test_texts)],
